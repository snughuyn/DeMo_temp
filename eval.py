...
def main(conf):
    ...
    checkpoint = to_absolute_path("/home/tako/DeMo_6/outputs/change_av2_ETRI_lane_default_baseline_default/20251017-123321/checkpoints/epoch=20.ckpt")  # TODO change to your checkpoint
