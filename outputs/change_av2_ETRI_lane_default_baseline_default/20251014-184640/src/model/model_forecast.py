...
#         self.lane_type_embed = nn.Parameter(torch.Tensor(3, embed_dim))  ## self.lane_type_embed = nn.Parameter(torch.Tensor(3, embed_dim))  원래 코드임
...
class ModelForecast(nn.Module):
    def __init__(
        ...
        self.lane_query_mlp = nn.Sequential(
